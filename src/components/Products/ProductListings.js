...
const ProductsBody = (props) => {
	...
	const productArray = props.allProducts.edges
		...
		.map((edge, productIndex) => {
			const product = edge.node;
			// combine categories and subCategories into single array for mapping
			const tagArray = [...product.categories, ...product.subCategories];
