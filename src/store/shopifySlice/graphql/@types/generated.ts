...
export type CheckoutCreateMutation = { checkoutCreate?: Maybe<{ checkout?: Maybe<CheckoutDetailsFragment> }> };
...
export type CheckoutLineItemsAddMutation = { checkoutLineItemsAdd?: Maybe<{ checkout?: Maybe<CheckoutDetailsFragment> }> };
...
export type CheckoutLineItemsRemoveMutation = { checkoutLineItemsRemove?: Maybe<{ checkout?: Maybe<CheckoutDetailsFragment> }> };
...
export const useCheckoutCreateMutation = <
    ...
    useMutation<CheckoutCreateMutation, TError, CheckoutCreateMutationVariables, TContext>(
      (variables?: CheckoutCreateMutationVariables) => fetcher<CheckoutCreateMutation, CheckoutCreateMutationVariables>(client, CheckoutCreateDocument, variables)(),
      options
    );
export const CheckoutLineItemsAddDocument = `
  ...
  checkoutLineItemsAdd(checkoutId: $checkoutId, lineItems: $lineItems) {
    ...
    ${CheckoutDetailsFragment}`;
export const useCheckoutLineItemsAddMutation = <
      TError = unknown,
      TContext = unknown
    >(
      client: GraphQLClient, 
      options?: UseMutationOptions<CheckoutLineItemsAddMutation, TError, CheckoutLineItemsAddMutationVariables, TContext>
    ) => 
    useMutation<CheckoutLineItemsAddMutation, TError, CheckoutLineItemsAddMutationVariables, TContext>(
      (variables?: CheckoutLineItemsAddMutationVariables) => fetcher<CheckoutLineItemsAddMutation, CheckoutLineItemsAddMutationVariables>(client, CheckoutLineItemsAddDocument, variables)(),
      options
    );
export const CheckoutLineItemsRemoveDocument = `
  ...
  checkoutLineItemsRemove(checkoutId: $checkoutId, lineItemIds: $lineItemIds) {
    ...
    ${CheckoutDetailsFragment}`;
export const useCheckoutLineItemsRemoveMutation = <
      TError = unknown,
      TContext = unknown
    >(
      client: GraphQLClient, 
      options?: UseMutationOptions<CheckoutLineItemsRemoveMutation, TError, CheckoutLineItemsRemoveMutationVariables, TContext>
    ) => 
    useMutation<CheckoutLineItemsRemoveMutation, TError, CheckoutLineItemsRemoveMutationVariables, TContext>(
      (variables?: CheckoutLineItemsRemoveMutationVariables) => fetcher<CheckoutLineItemsRemoveMutation, CheckoutLineItemsRemoveMutationVariables>(client, CheckoutLineItemsRemoveDocument, variables)(),
      options
    );
export const CheckoutLineItemsUpdateDocument = `
  ...
  checkoutLineItemsUpdate(checkoutId: $checkoutId, lineItems: $lineItems) {
    ...
    ${CheckoutDetailsFragment}`;
export const useCheckoutLineItemsUpdateMutation = <
      TError = unknown,
      TContext = unknown
    >(
      client: GraphQLClient, 
      options?: UseMutationOptions<CheckoutLineItemsUpdateMutation, TError, CheckoutLineItemsUpdateMutationVariables, TContext>
    ) => 
    useMutation<CheckoutLineItemsUpdateMutation, TError, CheckoutLineItemsUpdateMutationVariables, TContext>(
